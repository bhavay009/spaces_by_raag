...
export const site = {
  ...
  // Shown as "{location} — {locationScope}" in the hero and footer.
  locationScope: "Residential, Hospitality & Office Interiors",
...
export const projects = [
  {
    slug: "m3m",
    name: "Penthouses at M3M",
    location: "Gurgaon, India",
    type: "Penthouses",
    value: "₹ 5 Cr",
    area: "13,000 sq. ft. each",
    ...
    // m3m-2 leads: it's the highest-resolution frame in this set (1200x675 vs
    // 540x675 for m3m-1), and the lead slot renders far larger on screen than
    // the supporting thumbnails, where the resolution gap is invisible.
    images: ["m3m-2", "m3m-1", "m3m-3", "m3m-4"],
    alt: "Double-height living room with bespoke joinery and sculptural pendant lighting at a 13,000 sq ft penthouse at M3M, Gurgaon",
  },
  {
    slug: "aavaas",
    name: "Aavaas",
  ...
  },
  {
    ...
    // The Work grid only shows the first 3 supporting frames; residence-5
    // (800x450) has more pixel area than residence-4 (640x361), so it leads
    // the supporting set and residence-4 is the one left unused.
    images: ["residence-1", "residence-2", "residence-3", "residence-5", "residence-4"],
