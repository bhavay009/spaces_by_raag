...
export default function Founder() {
  return (
    <section id="founder" className="grain-soft scroll-mt-24 bg-cream px-6 py-12 md:px-12 md:py-24">
      <div className="mx-auto grid max-w-[1400px] items-center gap-7 lg:grid-cols-12 lg:gap-20">
        <Reveal className="lg:order-2 lg:col-span-5">
          <div className="group relative aspect-[16/11] w-full overflow-hidden bg-espresso shadow-[0_18px_50px_-30px_rgba(26,17,9,.55)] md:aspect-[4/5]">
            <Image
        ...
        <Reveal delay={120} className="lg:order-1 lg:col-span-7">
          ...
          <h2 className="font-display mt-3 text-[clamp(2.1rem,4.6vw,3.4rem)] leading-[1.12] tracking-[-0.015em] text-espresso md:mt-6">
            Ridham Girotra
          </h2>
          <p className="tracked-sm mt-2 text-[9.5px] text-espresso/70 md:mt-3.5">
            Founder &amp; Designer, Spaces by Raag
          </p>

          <div className="mt-4 max-w-xl space-y-4 text-[14px] leading-[1.6] text-espresso/72 md:mt-8 md:space-y-5 md:text-[16px] md:leading-[1.85]">
            <p>
          ...
          <blockquote className="mt-5 border-l border-bronze/50 pl-5 md:mt-10 md:pl-7">
            <p className="font-display text-[1.2rem] italic leading-[1.45] text-cognac md:text-[1.65rem] md:leading-[1.5]">
